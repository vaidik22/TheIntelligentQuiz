...
public class AddMoneyWalletTransFragment extends Fragment {

    private RecyclerView addMoneyWalletTransRecyclerView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_add_money_wallet_trans, container, false);
        textInputError = view.findViewById(R.id.textinput_error);
        addMoneyWalletTransRecyclerView = view.findViewById(R.id.addMoneyWalletTransRecyclerView);
        addMoneyWalletTransRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter = new TransactionAdapter(transactionList,"");
        addMoneyWalletTransRecyclerView.setAdapter(adapter);
        fetchTransactions();
