...
import com.binplus.TheIntelligentQuiz.Fragments.QuizDetailsPastFragment;
...
public class QuizAdapterPast extends RecyclerView.Adapter<QuizAdapterPast.QuizViewHolder> {
    private List<PastModel.Datum> quizList;
    private FragmentManager fragmentManager;

    public QuizAdapterPast(List<PastModel.Datum> quizModelList, FragmentManager fragmentManager) {
    ...
    public void onBindViewHolder(@NonNull QuizViewHolder holder, int position) {
        PastModel.Datum quizModel = quizList.get(position);
        ...
        holder.view_more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                QuizDetailsPastFragment quizDetailPastFragment = QuizDetailsPastFragment.newInstance(quizModel);

                fragmentManager
                        .beginTransaction()
                        .replace(R.id.homeFragment, quizDetailPastFragment)
                        .addToBackStack(null)
                        .commit();
            }
        });
